...
python inference-ner.py results/all_pdfs_inferred.csv results/all_pdfs_inferred.csv --model_path bilalzafar/CentralBank-NER --text_column textBlock --min_score 0.9
